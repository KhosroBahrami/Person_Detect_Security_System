...
python3 core/convert_tfrecord.py --dataset_txt ./red_blood_cell_dataset/train.txt --tfrecord_path_prefix ./red_blood_cell_dataset/rbc_train
python3 core/convert_tfrecord.py --dataset_txt ./red_blood_cell_dataset/test.txt  --tfrecord_path_prefix ./red_blood_cell_dataset/rbc_test
